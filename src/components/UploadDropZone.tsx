      ...
      <div
        ...
        className={`relative rounded-2xl border-2 border-dashed p-3 text-center transition-all cursor-pointer ${
          isDragOver
            ...
            : 'border-zinc-800 bg-zinc-900/60 hover:border-violet-500/40 hover:bg-zinc-900'
        }`}
      >
  ...
  return (
    <div
      ...
      className={`relative rounded-3xl border-2 border-dashed p-6 text-center transition-all duration-200 cursor-pointer overflow-hidden ${
        isDragOver
          ? 'border-violet-400 bg-violet-500/15 ring-4 ring-violet-500/20 scale-[1.01]'
          : 'border-zinc-800 bg-zinc-900/50 hover:border-violet-500/50 hover:bg-zinc-900/80'
      }`}
    >
      <label className="cursor-pointer flex flex-col items-center justify-center space-y-3">
        <div className="relative">
          <div className="w-14 h-14 rounded-2xl bg-violet-500/15 text-violet-400 border border-violet-500/30 flex items-center justify-center shadow-lg shadow-violet-950/40">
            <Upload className="w-7 h-7" />
          </div>
          <div className="absolute -top-1 -right-1 w-4 h-4 bg-violet-500 rounded-full flex items-center justify-center text-black">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-zinc-400">
            or <span className="text-violet-400 underline font-semibold">browse files</span> from your device
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 pt-1">
          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-zinc-800 text-[10px] text-zinc-400 font-mono border border-zinc-700">
            <Clipboard className="w-3 h-3 text-violet-400" /> Ctrl + V to Paste
          </span>
          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-zinc-800 text-[10px] text-zinc-400 font-mono border border-zinc-700">
            JPG, PNG, WEBP, GIF
          </span>

...
<button
  ...
  className="p-2 rounded-xl bg-zinc-900 hover:bg-violet-900/40 text-zinc-300 hover:text-violet-300 border border-zinc-800 transition-all duration-200 flex items-center gap-1"
>
